...
export default async function seed() {
  ...
  const insertUser = db.prepare(`INSERT INTO users (id, username, password_hash, first_name, last_name, role, credentials, specialty, npi, dea_number, email, epcs_pin_hash, two_factor_enabled, must_change_password, patient_id, location_id, is_global) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`);
  ...
  const users = [
      { id: 'u1', username: 'dr.chris', password: 'Pass123!', firstName: 'Chris', lastName: 'L.', role: 'prescriber', credentials: 'MD, PhD', specialty: 'Psychiatry', npi: '1234567890', deaNumber: 'FM1234567', email: 'chris.l@clarity.health', epcsPin: '9921', twoFactorEnabled: true, locationId: 'loc-apmg', isGlobal: false },
      { id: 'u2', username: 'np.joseph', password: 'Pass123!', firstName: 'Joseph', lastName: '', role: 'prescriber', credentials: 'PMHNP-BC', specialty: 'Psychiatric Mental Health', npi: '0987654321', deaNumber: 'FJ9876543', email: 'joseph@clarity.health', epcsPin: '4456', twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u3', username: 'irina.s', password: 'Pass123!', firstName: 'Irina', lastName: 'S.', role: 'prescriber', credentials: 'MD', specialty: 'Psychiatry', npi: '1122334455', deaNumber: 'FS1122334', email: 'irina.s@clarity.health', epcsPin: '7743', twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u4', username: 'nurse.kelly', password: 'Pass123!', firstName: 'Kelly', lastName: 'Chen', role: 'nurse', credentials: 'RN', specialty: 'Behavioral Health', npi: '', email: 'kelly.chen@clarity.health', epcsPin: null, twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u5', username: 'harriet', password: 'Pass123!', firstName: 'Harriet', lastName: 'Appiah', role: 'admin', credentials: '', specialty: '', npi: '', email: 'harriet@clarity.health', epcsPin: null, twoFactorEnabled: true, locationId: 'loc1', isGlobal: true },
      { id: 'u6', username: 'baz', password: 'Pass123!', firstName: 'Baz', lastName: '', role: 'front_desk', credentials: '', specialty: '', npi: '', email: 'baz@clarity.health', epcsPin: null, twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u7', username: 'amena', password: 'Pass123!', firstName: 'Amena', lastName: '', role: 'front_desk', credentials: '', specialty: '', npi: '', email: 'amena@clarity.health', epcsPin: null, twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u8', username: 'april.t', password: 'Pass123!', firstName: 'April', lastName: 'Torres', role: 'therapist', credentials: 'LCSW', specialty: 'Clinical Social Work', npi: '5566778899', email: 'april.t@clarity.health', epcsPin: null, twoFactorEnabled: true, locationId: 'loc1', isGlobal: false },
      { id: 'u9', username: 'dr.emmanuel', password: 'Pass123!', firstName: 'Emmanuel', lastName: 'Oforidanso', role: 'prescriber', credentials: 'NP', specialty: 'Psychiatric Mental Health', npi: '1376299933', deaNumber: 'MO7223857', email: 'emmanuel@clarity.health', epcsPin: '4412', twoFactorEnabled: true, locationId: 'loc-apmg', isGlobal: false },
      { id: 'pat-p1', username: 'james.anderson', password: 'Pass123!', firstName: 'James', lastName: 'Anderson', role: 'patient', credentials: '', specialty: '', npi: '', email: 'james.anderson@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p1', isGlobal: false },
      { id: 'pat-p2', username: 'maria.garcia', password: 'Pass123!', firstName: 'Maria', lastName: 'Garcia', role: 'patient', credentials: '', specialty: '', npi: '', email: 'maria.garcia@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p2', isGlobal: false },
      { id: 'pat-p3', username: 'robert.chen', password: 'Pass123!', firstName: 'Robert', lastName: 'Chen', role: 'patient', credentials: '', specialty: '', npi: '', email: 'robert.chen@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p3', isGlobal: false },
      { id: 'pat-p4', username: 'ashley.kim', password: 'Pass123!', firstName: 'Ashley', lastName: 'Kim', role: 'patient', credentials: '', specialty: '', npi: '', email: 'ashley.kim@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p4', isGlobal: false },
      { id: 'pat-p5', username: 'dorothy.wilson', password: 'Pass123!', firstName: 'Dorothy', lastName: 'Wilson', role: 'patient', credentials: '', specialty: '', npi: '', email: 'dorothy.wilson@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p5', isGlobal: false },
      { id: 'pat-p6', username: 'marcus.brown', password: 'Pass123!', firstName: 'Marcus', lastName: 'Brown', role: 'patient', credentials: '', specialty: '', npi: '', email: 'marcus.brown@email.com', epcsPin: null, twoFactorEnabled: false, patientId: 'p6', isGlobal: false },
    ];
    for (const u of users) {
      ...
      insertUser.run(u.id, u.username, hashPassword(u.password), u.firstName, u.lastName, u.role, u.credentials || '', u.specialty || '', u.npi || '', u.deaNumber || '', u.email, u.epcsPin ? hashPassword(u.epcsPin) : null, u.twoFactorEnabled ? 1 : 0, mustChange, u.patientId || null, u.locationId || 'loc1', u.isGlobal ? 1 : 0);
    }
    ...
    const practiceSettings = [
      { key: 'practice_name', value: 'Clarity Health', type: 'string', category: 'practice', description: 'Practice name' },
      { key: 'practice_address', value: '400 Wellness Blvd, Springfield, IL 62704', type: 'string', category: 'practice', description: 'Practice address' },
      { key: 'practice_phone', value: '(555) 800-1234', type: 'string', category: 'practice', description: 'Practice phone' },
      { key: 'practice_fax', value: '(555) 800-1235', type: 'string', category: 'practice', description: 'Practice fax' },
      { key: 'practice_npi', value: '1122334455', type: 'string', category: 'practice', description: 'Practice NPI' },
      { key: 'practice_tax_id', value: '12-3456789', type: 'string', category: 'practice', description: 'Tax ID / EIN' },
      { key: 'billing_contact', value: 'billing@clarity.health', type: 'string', category: 'billing', description: 'Billing contact email' },
      { key: 'default_copay', value: '30', type: 'number', category: 'billing', description: 'Default copay amount' },
      { key: 'auto_generate_claims', value: 'true', type: 'boolean', category: 'billing', description: 'Auto-generate claims on encounter close' },
    ];
    
    const insertPracticeSetting = db.prepare('INSERT INTO practice_settings (setting_key, setting_value, setting_type, category, description) VALUES (?,?,?,?,?)');
    for (const setting of practiceSettings) {
      insertPracticeSetting.run(setting.key, setting.value, setting.type, setting.category, setting.description);
    }

    // ── Fee Schedule ──
    const feeSchedule = [
      { cpt: '90791', desc: 'Psychiatric diagnostic evaluation', fee: 350, insurance: 'default' },
      { cpt: '90792', desc: 'Psychiatric diagnostic evaluation with medical services', fee: 380, insurance: 'default' },
      { cpt: '90834', desc: 'Psychotherapy, 45 minutes', fee: 150, insurance: 'default' },
      { cpt: '90837', desc: 'Psychotherapy, 60 minutes', fee: 200, insurance: 'default' },
      { cpt: '90853', desc: 'Group psychotherapy', fee: 120, insurance: 'default' },
      { cpt: '99213', desc: 'Office visit, established patient, 20-29 minutes', fee: 140, insurance: 'default' },
      { cpt: '99214', desc: 'Office visit, established patient, 30-39 minutes', fee: 180, insurance: 'default' },
      { cpt: '99215', desc: 'Office visit, established patient, 40-54 minutes', fee: 240, insurance: 'default' },
      { cpt: '96127', desc: 'Brief emotional/behavioral assessment', fee: 25, insurance: 'default' },
      // Medicare rates (typically lower)
      { cpt: '90791', desc: 'Psychiatric diagnostic evaluation', fee: 280, insurance: 'medicare' },
      { cpt: '90792', desc: 'Psychiatric diagnostic evaluation with medical services', fee: 310, insurance: 'medicare' },
      { cpt: '90834', desc: 'Psychotherapy, 45 minutes', fee: 120, insurance: 'medicare' },
      { cpt: '90837', desc: 'Psychotherapy, 60 minutes', fee: 160, insurance: 'medicare' },
      { cpt: '99214', desc: 'Office visit, established patient, 30-39 minutes', fee: 145, insurance: 'medicare' },
    ];

    const insertFeeSchedule = db.prepare('INSERT INTO fee_schedule (cpt_code, description, fee, effective_date, insurance_type) VALUES (?,?,?,?,?)');
    const effectiveDate = '2026-01-01';
    for (const fee of feeSchedule) {
      insertFeeSchedule.run(fee.cpt, fee.desc, fee.fee, effectiveDate, fee.insurance);
    }
