...
if (typeof window !== 'undefined' &&
    ...
    !window.location?.hostname?.includes('clarity-ehr.com')) {
...
export const users = [
  ...
  },
  {
    ...
    specialty: '',
    npi: '',
    email: 'localadmin@clarity.health',
    twoFactorEnabled: true,
  },
...
/*
  ...
  {
    id: 'pe1', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0',
    mrn: 'MRN-00013', firstName: 'Nadia', lastName: 'Osei',
    dob: '1988-07-14', age: 37, gender: 'Female', pronouns: 'She/Her',
    ssn: '***-**-4412', race: 'Black or African American', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Single', phone: '(404) 555-0191', cellPhone: '(404) 555-0192',
    email: 'nadia.osei@email.com',
    address: { street: '820 Peachtree St NE', city: 'Atlanta', state: 'GA', zip: '30308' },
    emergencyContact: { name: 'Abena Osei', relationship: 'Mother', phone: '(404) 555-0193' },
    insurance: { primary: { name: 'Aetna', memberId: 'AET881122334', groupNumber: 'GRP-9900', copay: 25 }, secondary: null },
    pcp: 'Dr. Sandra Mensah', assignedProvider: 'user-emmanuel',
    isBTG: false, isActive: true, lastVisit: '2026-05-20', nextAppointment: '2026-06-17',
    flags: ['Anxiety'],
  },
  {
    id: 'pe2', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0',
    mrn: 'MRN-00014', firstName: 'Kofi', lastName: 'Mensah',
    dob: '1995-03-08', age: 31, gender: 'Male', pronouns: 'He/Him',
    ssn: '***-**-6631', race: 'Black or African American', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Married', phone: '(404) 555-0281', cellPhone: '(404) 555-0282',
    email: 'kofi.mensah@email.com',
    address: { street: '210 Auburn Ave NE', city: 'Atlanta', state: 'GA', zip: '30303' },
    emergencyContact: { name: 'Ama Mensah', relationship: 'Spouse', phone: '(404) 555-0283' },
    insurance: { primary: { name: 'United Healthcare', memberId: 'UHC334455667', groupNumber: 'GRP-4411', copay: 30 }, secondary: null },
    pcp: 'Dr. James Acheampong', assignedProvider: 'user-emmanuel',
    isBTG: false, isActive: true, lastVisit: '2026-05-28', nextAppointment: '2026-06-25',
    flags: ['ADHD', 'Depression'],
  },
  {
    id: 'pe3', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0',
    mrn: 'MRN-00015', firstName: 'Akua', lastName: 'Boateng',
    dob: '1979-11-22', age: 46, gender: 'Female', pronouns: 'She/Her',
    ssn: '***-**-9901', race: 'Black or African American', ethnicity: 'Non-Hispanic', language: 'Twi',
    maritalStatus: 'Divorced', phone: '(404) 555-0371', cellPhone: '(404) 555-0372',
    email: 'akua.boateng@email.com',
    address: { street: '560 Joseph E Lowery Blvd', city: 'Atlanta', state: 'GA', zip: '30310' },
    emergencyContact: { name: 'Kweku Boateng', relationship: 'Son', phone: '(404) 555-0373' },
    insurance: { primary: { name: 'Blue Cross Blue Shield', memberId: 'BCB774411223', groupNumber: 'GRP-7722', copay: 20 }, secondary: null },
    pcp: 'Dr. Efua Asante', assignedProvider: 'user-emmanuel',
    isBTG: false, isActive: true, lastVisit: '2026-06-01', nextAppointment: '2026-06-29',
    flags: ['Bipolar II', 'Insomnia'],
  },

  // ─── Victory Mental Health patients ──────────────────────────────────────
  {
    id: 'pv1', locationId: 'loc-victory',
    mrn: 'MRN-00016', firstName: 'Marcus', lastName: 'Reeves',
    dob: '1982-09-05', age: 43, gender: 'Male', pronouns: 'He/Him',
    ssn: '***-**-3356', race: 'Black or African American', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Single', phone: '(708) 555-0111', cellPhone: '(708) 555-0112',
    email: 'marcus.reeves@email.com',
    address: { street: '7200 W 159th St', city: 'Tinley Park', state: 'IL', zip: '60477' },
    emergencyContact: { name: 'Diane Reeves', relationship: 'Sister', phone: '(708) 555-0113' },
    insurance: { primary: { name: 'Medicaid', memberId: 'MCD667788991', groupNumber: '', copay: 0 }, secondary: null },
    pcp: 'Dr. Patricia Oluwole', assignedProvider: 'u11',
    isBTG: false, isActive: true, lastVisit: '2026-05-15', nextAppointment: '2026-06-12',
    flags: ['Schizophrenia', 'Substance Use History'],
  },
  {
    id: 'pv2', locationId: 'loc-victory',
    mrn: 'MRN-00017', firstName: 'Latoya', lastName: 'Jenkins',
    dob: '1991-06-18', age: 34, gender: 'Female', pronouns: 'She/Her',
    ssn: '***-**-7712', race: 'Black or African American', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Married', phone: '(708) 555-0221', cellPhone: '(708) 555-0222',
    email: 'latoya.jenkins@email.com',
    address: { street: '18100 S Oak Park Ave', city: 'Tinley Park', state: 'IL', zip: '60477' },
    emergencyContact: { name: 'Darnell Jenkins', relationship: 'Husband', phone: '(708) 555-0223' },
    insurance: { primary: { name: 'Cigna', memberId: 'CIG445566778', groupNumber: 'GRP-5533', copay: 25 }, secondary: null },
    pcp: 'Dr. Michael Adesanya', assignedProvider: 'u11',
    isBTG: false, isActive: true, lastVisit: '2026-05-22', nextAppointment: '2026-06-19',
    flags: ['PTSD', 'Anxiety'],
  },

  // ─── Rolling Meadows (APMG) patients ─────────────────────────────────────
  {
    id: 'pa1', locationId: 'loc-apmg',
    mrn: 'MRN-00018', firstName: 'Brian', lastName: 'Kowalski',
    dob: '1975-04-12', age: 51, gender: 'Male', pronouns: 'He/Him',
    ssn: '***-**-8821', race: 'White', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Married', phone: '(847) 555-0141', cellPhone: '(847) 555-0142',
    email: 'brian.kowalski@email.com',
    address: { street: '1540 Hicks Rd', city: 'Rolling Meadows', state: 'IL', zip: '60008' },
    emergencyContact: { name: 'Karen Kowalski', relationship: 'Spouse', phone: '(847) 555-0143' },
    insurance: { primary: { name: 'Blue Cross Blue Shield', memberId: 'BCB991122334', groupNumber: 'GRP-6644', copay: 30 }, secondary: null },
    pcp: 'Dr. Thomas Walsh', assignedProvider: 'u1',
    isBTG: false, isActive: true, lastVisit: '2026-05-10', nextAppointment: '2026-06-07',
    flags: ['Depression', 'Chronic Pain'],
  },
  {
    id: 'pa2', locationId: 'loc-apmg',
    mrn: 'MRN-00019', firstName: 'Christine', lastName: 'Nowak',
    dob: '1998-01-30', age: 28, gender: 'Female', pronouns: 'She/Her',
    ssn: '***-**-5544', race: 'White', ethnicity: 'Non-Hispanic', language: 'Polish',
    maritalStatus: 'Single', phone: '(847) 555-0251', cellPhone: '(847) 555-0252',
    email: 'christine.nowak@email.com',
    address: { street: '800 N Rohlwing Rd', city: 'Rolling Meadows', state: 'IL', zip: '60008' },
    emergencyContact: { name: 'Zbigniew Nowak', relationship: 'Father', phone: '(847) 555-0253' },
    insurance: { primary: { name: 'Aetna', memberId: 'AET223344556', groupNumber: 'GRP-3322', copay: 20 }, secondary: null },
    pcp: 'Dr. Anna Wiśniewska', assignedProvider: 'u1',
    isBTG: false, isActive: true, lastVisit: '2026-05-18', nextAppointment: '2026-06-15',
    flags: ['Anxiety', 'OCD'],
  },

  // ─── BridgePoint Wellness patients ───────────────────────────────────────
  {
    id: 'pb1', locationId: '2779f608-aff9-4a3f-a776-deba3fb899ef',
    mrn: 'MRN-00020', firstName: 'Sandra', lastName: 'Mitchell',
    dob: '1970-08-24', age: 55, gender: 'Female', pronouns: 'She/Her',
    ssn: '***-**-6677', race: 'White', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Widowed', phone: '(630) 555-0161', cellPhone: '(630) 555-0162',
    email: 'sandra.mitchell@email.com',
    address: { street: '245 Carpenter St', city: 'Wheaton', state: 'IL', zip: '60187' },
    emergencyContact: { name: 'Kevin Mitchell', relationship: 'Son', phone: '(630) 555-0163' },
    insurance: { primary: { name: 'Medicare', memberId: 'MCR778899001', groupNumber: '', copay: 15 }, secondary: null },
    pcp: 'Dr. Robert Conway', assignedProvider: '268c2dfe-f8ac-402c-89be-f095f3f2e1cd',
    isBTG: false, isActive: true, lastVisit: '2026-05-12', nextAppointment: '2026-06-09',
    flags: ['Grief', 'Depression'],
  },
  {
    id: 'pb2', locationId: '2779f608-aff9-4a3f-a776-deba3fb899ef',
    mrn: 'MRN-00021', firstName: 'Ryan', lastName: 'Fitzgerald',
    dob: '2000-12-03', age: 25, gender: 'Male', pronouns: 'He/Him',
    ssn: '***-**-3390', race: 'White', ethnicity: 'Non-Hispanic', language: 'English',
    maritalStatus: 'Single', phone: '(630) 555-0271', cellPhone: '(630) 555-0272',
    email: 'ryan.fitzgerald@email.com',
    address: { street: '410 N Main St', city: 'Glen Ellyn', state: 'IL', zip: '60137' },
    emergencyContact: { name: 'Mary Fitzgerald', relationship: 'Mother', phone: '(630) 555-0273' },
    insurance: { primary: { name: 'United Healthcare', memberId: 'UHC112233445', groupNumber: 'GRP-8811', copay: 30 }, secondary: null },
    pcp: 'Dr. Sean Brady', assignedProvider: '268c2dfe-f8ac-402c-89be-f095f3f2e1cd',
...
/*
  ...
  // ═══════════════════════════════════════════════════════════
  { id: 'today1', patientId: 'p1', patientName: 'James Anderson', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '08:00', duration: 30, type: 'Follow-Up', status: 'Checked In', reason: 'Sertraline 150mg follow-up, PHQ-9 recheck', visitType: 'In-Person', room: 'Room 3' },
  { id: 'today2', patientId: 'p2', patientName: 'Maria Garcia', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '08:30', duration: 60, type: 'Follow-Up', status: 'Checked In', reason: 'PTSD — Prazosin dose adjustment, nightmare frequency review', visitType: 'In-Person', room: 'Room 2' },
  { id: 'today3', patientId: 'p4', patientName: 'Emily Chen', provider: 'u2', providerName: 'Joseph', date: '2026-06-01', time: '08:30', duration: 30, type: 'Follow-Up', status: 'Checked In', reason: 'ADHD — Adderall XR refill, weight/BP check', visitType: 'In-Person', room: 'Room 1' },
  { id: 'today4', patientId: 'p5', patientName: 'Robert Wilson', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '09:30', duration: 45, type: 'Follow-Up', status: 'Confirmed', reason: 'Depression & cognitive decline — caregiver present, MMSE', visitType: 'In-Person', room: 'Room 3' },
  { id: 'today5', patientId: 'p3', patientName: 'David Thompson', provider: 'u2', providerName: 'Joseph', date: '2026-06-01', time: '09:00', duration: 30, type: 'Follow-Up', status: 'Confirmed', reason: 'AUD management — 6-month sobriety milestone, naltrexone refill', visitType: 'In-Person', room: 'Room 4' },
  { id: 'today6', patientId: 'p6', patientName: 'Aisha Patel', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '10:15', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Bipolar — Lamotrigine 50mg check, mood diary review', visitType: 'Telehealth', room: 'Virtual' },
  { id: 'today7', patientId: null, patientName: 'New Patient - Rachel Kim', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '11:00', duration: 60, type: 'New Patient', status: 'Confirmed', reason: 'Initial psych eval — severe anxiety, panic attacks, agoraphobia', visitType: 'In-Person', room: 'Room 2' },
  { id: 'today8', patientId: 'p4', patientName: 'Emily Chen', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '10:00', duration: 50, type: 'Individual Therapy', status: 'Scheduled', reason: 'DBT skills — distress tolerance, body image work', visitType: 'In-Person', room: 'Room 5', therapyModality: 'DBT', sessionNumber: 8 },
  { id: 'today9', patientId: 'p1', patientName: 'James Anderson', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '11:00', duration: 50, type: 'Individual Therapy', status: 'Scheduled', reason: 'CBT — cognitive restructuring, behavioral activation homework', visitType: 'In-Person', room: 'Room 5', therapyModality: 'CBT', sessionNumber: 16 },
  { id: 'today10', patientId: null, patientName: 'New Patient - Marcus Williams', provider: 'u2', providerName: 'Joseph', date: '2026-06-01', time: '10:00', duration: 60, type: 'New Patient', status: 'Scheduled', reason: 'Initial evaluation — insomnia, work-related stress, possible GAD', visitType: 'Telehealth', room: 'Virtual' },
  { id: 'today11', patientId: 'p2', patientName: 'Maria Garcia', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '13:00', duration: 60, type: 'Individual Therapy', status: 'Scheduled', reason: 'Trauma-focused CBT — EMDR session 3, processing session', visitType: 'In-Person', room: 'Room 5', therapyModality: 'EMDR', sessionNumber: 10 },
  { id: 'today12', patientId: 'p5', patientName: 'Robert Wilson', provider: 'u2', providerName: 'Joseph', date: '2026-06-01', time: '11:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Dementia monitoring — medication reconciliation', visitType: 'In-Person', room: 'Room 1' },
  { id: 'today13', patientId: 'p6', patientName: 'Aisha Patel', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '14:00', duration: 50, type: 'Individual Therapy', status: 'Scheduled', reason: 'IPSRT — mood regulation, interpersonal rhythms', visitType: 'Telehealth', room: 'Virtual', therapyModality: 'IPSRT', sessionNumber: 12 },
  { id: 'today14', patientId: 'p1', patientName: 'James Anderson', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '13:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'GAD management — Buspirone consideration, therapy coordination', visitType: 'Telehealth', room: 'Virtual' },
  { id: 'today15', patientId: 'p3', patientName: 'David Thompson', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '15:00', duration: 50, type: 'Individual Therapy', status: 'Scheduled', reason: 'MET/CBT — relapse prevention planning, urge surfing', visitType: 'In-Person', room: 'Room 5', therapyModality: 'MET/CBT', sessionNumber: 24 },
  { id: 'today16', patientId: null, patientName: 'New Patient - Priya Sharma', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '14:00', duration: 60, type: 'New Patient', status: 'Confirmed', reason: 'Initial eval — postpartum depression and anxiety, 4 months postpartum', visitType: 'In-Person', room: 'Room 2' },
  { id: 'today17', patientId: 'p3', patientName: 'David Thompson', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '15:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Bupropion follow-up, nicotine dependence discussion', visitType: 'In-Person', room: 'Room 3' },
  { id: 'today18', patientId: null, patientName: 'Group Session - Anxiety Management', provider: 'u8', providerName: 'April T., LCSW', date: '2026-06-01', time: '16:00', duration: 90, type: 'Group Therapy', status: 'Scheduled', reason: 'Weekly anxiety management group — exposure hierarchy review', visitType: 'In-Person', room: 'Group Room A', therapyModality: 'Group CBT', sessionNumber: 20, groupMembers: ['p1', 'p2', 'p4', 'p6'] },
  { id: 'today19', patientId: 'p4', patientName: 'Emily Chen', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-01', time: '15:30', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Anxiety — GAD-7 recheck, eating disorder screen', visitType: 'Telehealth', room: 'Virtual' },
  ...
  // ── Emmanus Wellness appointments ────────────────────────────────────────
  { id: 'em1', patientId: 'pe1', patientName: 'Nadia Osei', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-05-20', time: '10:00', duration: 45, type: 'Follow-Up', status: 'Completed', reason: 'Generalized Anxiety — Escitalopram 10mg tolerability, GAD-7', visitType: 'In-Person', room: 'Room 1', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },
  { id: 'em2', patientId: 'pe2', patientName: 'Kofi Mensah', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-05-28', time: '11:00', duration: 30, type: 'Follow-Up', status: 'Completed', reason: 'ADHD + MDD — Adderall XR 20mg refill, mood check', visitType: 'In-Person', room: 'Room 2', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },
  { id: 'em3', patientId: 'pe3', patientName: 'Akua Boateng', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-06-01', time: '09:00', duration: 60, type: 'Follow-Up', status: 'Completed', reason: 'Bipolar II — Lamotrigine 100mg level, mood diary, sleep', visitType: 'In-Person', room: 'Room 1', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },
  { id: 'em4', patientId: 'pe1', patientName: 'Nadia Osei', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-06-17', time: '10:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Anxiety — 4-week Escitalopram check, CBT progress', visitType: 'In-Person', room: 'Room 1', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },
  { id: 'em5', patientId: 'pe2', patientName: 'Kofi Mensah', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-06-25', time: '11:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'ADHD — executive function, medication optimization', visitType: 'In-Person', room: 'Room 2', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },
  { id: 'em6', patientId: 'pe3', patientName: 'Akua Boateng', provider: 'user-emmanuel', providerName: 'Emmanuel Ofori-Danso, NP', date: '2026-06-29', time: '09:00', duration: 45, type: 'Follow-Up', status: 'Scheduled', reason: 'Bipolar II — mood stability, Lamotrigine titration to 150mg', visitType: 'In-Person', room: 'Room 1', locationId: 'bdaec5ec-50fd-4fa2-bafc-7b2fefcc5dd0' },

  // ── Victory Mental Health appointments ───────────────────────────────────
  { id: 'vt1', patientId: 'pv1', patientName: 'Marcus Reeves', provider: 'u11', providerName: 'Idayatu Ola Omoniyi, NP', date: '2026-05-15', time: '09:30', duration: 45, type: 'Follow-Up', status: 'Completed', reason: 'Schizophrenia — Paliperidone LAI injection, PANSS screen', visitType: 'In-Person', room: 'Room A', locationId: 'loc-victory' },
  { id: 'vt2', patientId: 'pv2', patientName: 'Latoya Jenkins', provider: 'u11', providerName: 'Idayatu Ola Omoniyi, NP', date: '2026-05-22', time: '10:30', duration: 30, type: 'Follow-Up', status: 'Completed', reason: 'PTSD + Anxiety — Sertraline 100mg refill, PCL-5', visitType: 'Telehealth', room: 'Virtual', locationId: 'loc-victory' },
  { id: 'vt3', patientId: 'pv1', patientName: 'Marcus Reeves', provider: 'u11', providerName: 'Idayatu Ola Omoniyi, NP', date: '2026-06-12', time: '09:30', duration: 45, type: 'Follow-Up', status: 'Scheduled', reason: 'Schizophrenia — monthly injection, medication review', visitType: 'In-Person', room: 'Room A', locationId: 'loc-victory' },
  { id: 'vt4', patientId: 'pv2', patientName: 'Latoya Jenkins', provider: 'u11', providerName: 'Idayatu Ola Omoniyi, NP', date: '2026-06-19', time: '10:30', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'PTSD — trauma therapy referral coordination', visitType: 'Telehealth', room: 'Virtual', locationId: 'loc-victory' },

  // ── Rolling Meadows (APMG) appointments ──────────────────────────────────
  { id: 'rm1', patientId: 'pa1', patientName: 'Brian Kowalski', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-05-10', time: '10:00', duration: 45, type: 'Follow-Up', status: 'Completed', reason: 'Depression + Chronic Pain — Duloxetine 60mg, PHQ-9', visitType: 'In-Person', room: 'RM Room 1', locationId: 'loc-apmg' },
  { id: 'rm2', patientId: 'pa2', patientName: 'Christine Nowak', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-05-18', time: '11:00', duration: 30, type: 'Follow-Up', status: 'Completed', reason: 'OCD — Fluvoxamine 100mg refill, Y-BOCS', visitType: 'In-Person', room: 'RM Room 2', locationId: 'loc-apmg' },
  { id: 'rm3', patientId: 'pa1', patientName: 'Brian Kowalski', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-07', time: '10:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'Depression — Duloxetine 90mg consideration', visitType: 'In-Person', room: 'RM Room 1', locationId: 'loc-apmg' },
  { id: 'rm4', patientId: 'pa2', patientName: 'Christine Nowak', provider: 'u1', providerName: 'Dr. Chris L.', date: '2026-06-15', time: '11:00', duration: 30, type: 'Follow-Up', status: 'Scheduled', reason: 'OCD + Anxiety — ERP therapy progress review', visitType: 'In-Person', room: 'RM Room 2', locationId: 'loc-apmg' },

  // ── BridgePoint Wellness appointments ────────────────────────────────────
  { id: 'bp1', patientId: 'pb1', patientName: 'Sandra Mitchell', provider: '268c2dfe-f8ac-402c-89be-f095f3f2e1cd', providerName: 'Dr. Emelia Appiagyei', date: '2026-05-12', time: '13:00', duration: 60, type: 'Follow-Up', status: 'Completed', reason: 'Grief + Depression — Mirtazapine 30mg, bereavement counseling', visitType: 'In-Person', room: 'BP Room 1', locationId: '2779f608-aff9-4a3f-a776-deba3fb899ef' },
...
export const pharmacies = [
  ...
  { id: 'ph_w180', name: 'Walgreens #8831', chain: 'Walgreens', address: '1430 Huntley Rd', city: 'Carpentersville', state: 'IL', zip: '60110', phone: '(847) 428-0562', fax: '(847) 428-0563', npi: '1710900180' },
  { id: 'ph72', name: 'CVS Pharmacy #8200', chain: 'CVS', address: '205 W Randolph St', city: 'Chicago', state: 'IL', zip: '60606', phone: '(312) 782-8820', fax: '(312) 782-8821', npi: '0010200073' },
