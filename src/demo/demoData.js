...
export const DEMO_APPOINTMENTS = [
  { id: 'demo-apt1', patientId: 'demo-p1', patientName: 'Sarah Mitchell', provider: 'demo-u1', providerName: 'Dr. Danso', date: fmtDate(0), time: '08:00', duration: 50, type: 'Individual Therapy', status: 'Completed', reason: 'CBT — anxiety management, breathing techniques', visitType: 'In-Person', room: 'Room 2' },
  { id: 'demo-apt2', patientId: 'demo-p2', patientName: 'Marcus Johnson', provider: 'demo-u1', providerName: 'Dr. Danso', date: fmtDate(0), time: '09:00', duration: 30, type: 'Medication Review', status: 'Checked In', reason: 'Sertraline 100mg — 3-month follow-up, PHQ-9 recheck', visitType: 'In-Person', room: 'Room 3' },
  ...
  { id: 'demo-apt4', patientId: 'demo-p4', patientName: 'David Kim', provider: 'demo-u1', providerName: 'Dr. Danso', date: fmtDate(0), time: '10:30', duration: 30, type: 'Follow-Up', status: 'Confirmed', reason: 'PTSD follow-up — Prazosin adjustment, nightmare log review', visitType: 'In-Person', room: 'Room 3' },
  { id: 'demo-apt5', patientId: 'demo-p6', patientName: 'Thomas Washington', provider: 'demo-u1', providerName: 'Dr. Danso', date: fmtDate(0), time: '11:00', duration: 45, type: 'Follow-Up', status: 'Scheduled', reason: 'Depression + mild cognitive impairment — MoCA retest', visitType: 'In-Person', room: 'Room 2' },
  ...
  { id: 'demo-apt7', patientId: null, patientName: 'New Patient — Alex Rivera', provider: 'demo-u1', providerName: 'Dr. Danso', date: fmtDate(0), time: '14:00', duration: 60, type: 'New Patient', status: 'Confirmed', reason: 'Initial psych eval — severe anxiety, panic attacks, work-related stress', visitType: 'In-Person', room: 'Room 3' },
