...
export const SITES_FALLBACK = [
  { id: 'all',      name: 'All Sites',                          shortName: 'All Sites',        type: 'Meta',      icon: '🌐' },
  {
    ...
    shortName: 'Rolling Meadows',
    type: 'Primary',
    icon: '🏥',
    address: '2 Golf Center, Suite 240',
  ...
  {
    id: 'loc2',
    name: 'Clarity — West Loop',
    shortName: 'West Loop',
    type: 'Satellite',
    icon: '📍',
    address: '833 W Jackson Blvd, Suite 500',
  ...
  {
    id: 'loc3',
    name: 'Clarity — Evanston',
    shortName: 'Evanston',
    type: 'Satellite',
    icon: '📍',
    address: '1603 Orrington Ave, Suite 100',
  ...
  {
    id: 'loc4',
    name: 'Clarity — Telehealth Only',
    shortName: 'Telehealth',
    type: 'Virtual',
    icon: '💻',
    address: 'Telehealth — No Physical Location',
    city: '', state: '', zip: '',
    phone: '(312) 555-0200',
    fax: '(312) 555-0201',
    npi: '',
  },
  {
    ...
    type: 'Primary',
    icon: '🏥',
    address: '7060 Centennial Drive, Suite 102C',
...
function dbLocToSite(loc) {
  ...
  return {
    ...
    icon:      icons[loc.type] || '🏥',
    // Contact / address fields — passed through from DB so order slips use real data
    address:   loc.address || loc.street_address || '',
    city:      loc.city || '',
    state:     loc.state || '',
    zip:       loc.zip || loc.postal_code || '',
    phone:     loc.phone || loc.phoneNumber || '',
    fax:       loc.fax || loc.faxNumber || '',
    npi:       loc.npi || loc.organizationNpi || '',
  };
}
